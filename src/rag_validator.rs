...
use crate::document_index::{DocumentIndex, SearchResult};
...
impl RAGValidator {
    pub fn new(index: DocumentIndex, corpus_root: PathBuf) -> Result<Self> {
...
mod tests {
    ...
    fn test_calculate_confidence_empty() {
        ...
        let validator = RAGValidator {
            index: DocumentIndex::new(PathBuf::from("/tmp"), default_extensions),
