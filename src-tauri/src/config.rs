...
pub struct DriverConfig {
    ...
    pub ollama_auto_open_download: bool,
...
impl Default for DriverConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            ollama_path: None,
            ollama_auto_open_download: false,
...
pub fn load_driver_config() -> Result<DriverConfig, String> {
    ...
    let final_cfg = DriverConfig {
        ...
        ollama_auto_open_download: cfg.ollama_auto_open_download,
...
pub fn save_driver_config(cfg: &DriverConfig) -> Result<(), String> {
    ...
    let cfg_to_save = DriverConfig {
        ...
        ollama_path: cfg.ollama_path.clone(),
        ollama_auto_open_download: cfg.ollama_auto_open_download,
