...
use local_doc_assistant::{OllamaClient, PromptBuilder, DocumentIndex, RAGValidator, ModelTester};
...
async fn main() -> Result<()> {
    ...
    let mut doc_index = DocumentIndex::new(mud_references_path.clone(), default_extensions);
